...
data[['Batch Group', 'Batch Group Number']] = data['Batch'].str.split('-',
                                                                      expand=True)  # Split the 'Batch' Column into two columns.
...
groups = filtered_data['Batch'].unique()
selected_batch_group = st.selectbox("Select Group", groups)

filtered_data = filtered_data[filtered_data['Batch']==selected_batch_group]
